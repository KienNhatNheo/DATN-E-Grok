...
<body>
    <div class="d-flex">
      ...
      <div style="width:82%;margin-left:18%">
        <h3 style="margin-top:3rem;margin-bottom:3rem;text-align:center">Cập nhật sản phẩm</h3>
            ...
            <table class="table table-hover table-borderless rounded">
                <tbody>
                  <tr class="rounded-top">
                    ...
                    <td><input autofocus class="uIinput" style="background: none;width:500px;" type="text" name="productName" value="{{ $item->product_name }}"></td>
                  </tr>
                  <tr>
                    <td style="background-color: rgb(221, 220, 218);padding:0.5rem 1.2rem">Giá sản phẩm</td>
                    <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productPrice" value="{{ $item->product_price }}"></td>
                  </tr>
                  <tr>
                    <td style="background-color: rgb(195, 185, 185);padding:0.5rem 1.2rem">Hình ảnh</td>
                    <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productImage" value="{{ $item->product_image }}"></td>
                  </tr>
                  <tr>
                      <td style="background-color: rgb(221, 220, 218);padding:0.5rem 1.2rem">Giảm giá</td>
                      <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productDiscount" value="{{ $item->product_discount }}"></td>
                    </tr>
                    <tr>
                        <td style="background-color: rgb(195, 185, 185);padding:0.5rem 1.2rem">Phân loại</td>
                        <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productType" value="{{ $item->product_type }}"></td>
                    </tr>
                    <tr>
                        <td style="background-color: rgb(221, 220, 218);padding:0.5rem 1.2rem">Sản phẩm có sẵn</td>
                        <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productAvailable" value="{{ $item->product_available }}"></td>
                      </tr>
                      <tr>
                        <td style="background-color: rgb(195, 185, 185);padding:0.5rem 1.2rem">Mô tả</td>
                        <td><input class="uIinput" style="background: none;width:500px;" type="text" name="productDetail" value="{{ $item->product_detail }}"></td>
                      </tr>
                </tbody>
              </table>
